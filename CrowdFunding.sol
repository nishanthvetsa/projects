...
contract CrowdFunding{
    ...
    constructor(uint _target,uint _deadline){
        target=_target;
        deadline=block.timestamp+_deadline; //l10sec + 3600sec (60*60)
    ...
    function voteRequest(uint _requestNo) public{ 
        require(raisedAmount>target,"You cannot withdraw the amount as target has been achieved"); 
    ...
    function makePayment(uint _requestNo) public onlyManger{
        ...
        require(thisRequest.noOfVoters > noOfContributors/2,"You dont have the majority");
